...
class S_DES :
    ...
    S0 = {(0,0):1, (0,1):0, (0,2):3, (0,3):2, (1,0):3, (1,1):2, (1,2):1, (1,3):0, (2,0):0, (2,1):2, (2,2):1, (2,3):3, (3,0):3, (3,1):1, (3,2):3, (3,3):2}
    S1 = {(0,0):0, (0,1):1, (0,2):2, (0,3):3, (1,0):2, (1,1):0, (1,2):1, (1,3):3, (2,0):3, (2,1):0, (2,2):1, (2,3):0, (3,0):2, (3,1):1, (3,2):0, (3,3):3}
    P4 = {8:3, 10:2, 9:1, 7:0}
...
plainText = int(input("8자리 10진수 평문 입력 : "), 2)
